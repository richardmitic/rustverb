...
impl Reverb {
    pub fn new(sample_rate: f64) -> Reverb {
        ...
        Reverb {
            ...
            lpfcomb3: LPFCombFilter::new(
                samples_from_ms(40.23, sample_rate),
                comb_feedback,
                sample_rate,
                11000.,
            ),
            lpfcomb4: LPFCombFilter::new(
                samples_from_ms(44.14, sample_rate),
                comb_feedback,
                sample_rate,
                9000.,
            ),
            ...
            lpfcomb7: LPFCombFilter::new(
                samples_from_ms(41.55, sample_rate),
                comb_feedback,
                sample_rate,
                11000.,
            ),
            lpfcomb8: LPFCombFilter::new(
                samples_from_ms(42.58, sample_rate),
                comb_feedback,
                sample_rate,
                9000.,
            ),
...
mod tests {
    ...
    fn test_reverb_noise() {
        ...
        save_stereo(&filtered, "test_reverb_noise_filtered.wav").unwrap();
    }
